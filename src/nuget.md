[Documentation](https://github.com/VerifyTests/Verify.Syncfusion)
...
**See [Milestones](https://github.com/VerifyTests/Verify.Syncfusion/milestones?state=closed) for release notes.**
